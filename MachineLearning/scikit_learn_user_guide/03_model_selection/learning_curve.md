...
[![../_images/sphx_glr_plot_underfitting_overfitting_001.png](../_images/sphx_glr_plot_underfitting_overfitting_001.png) ](<../auto_examples/model_selection/plot_underfitting_overfitting.html>)
...
Examples
  ...
  * [Effect of model regularization on training and test error](<../auto_examples/model_selection/plot_train_error_vs_test_error.html#sphx-glr-auto-examples-model-selection-plot-train-error-vs-test-error-py>)

  * [Plotting Learning Curves and Checking Models’ Scalability](<../auto_examples/model_selection/plot_learning_curve.html#sphx-glr-auto-examples-model-selection-plot-learning-curve-py>)
...
The function [`validation_curve`](<generated/sklearn.model_selection.validation_curve.html#sklearn.model_selection.validation_curve> "sklearn.model_selection.validation_curve") can help in this case:
...
If you intend to plot the validation curves only, the class [`ValidationCurveDisplay`](<generated/sklearn.model_selection.ValidationCurveDisplay.html#sklearn.model_selection.ValidationCurveDisplay> "sklearn.model_selection.ValidationCurveDisplay") is more direct than using matplotlib manually on the results of a call to [`validation_curve`](<generated/sklearn.model_selection.validation_curve.html#sklearn.model_selection.validation_curve> "sklearn.model_selection.validation_curve"). You can use the method [`from_estimator`](<generated/sklearn.model_selection.ValidationCurveDisplay.html#sklearn.model_selection.ValidationCurveDisplay.from_estimator> "sklearn.model_selection.ValidationCurveDisplay.from_estimator") similarly to [`validation_curve`](<generated/sklearn.model_selection.validation_curve.html#sklearn.model_selection.validation_curve> "sklearn.model_selection.validation_curve") to generate and plot the validation curve:
...
![../_images/learning_curve-1.png](../_images/learning_curve-1.png)
...
[![../_images/sphx_glr_plot_learning_curve_001.png](../_images/sphx_glr_plot_learning_curve_001.png) ](<../auto_examples/model_selection/plot_learning_curve.html>)
...
If you intend to plot the learning curves only, the class [`LearningCurveDisplay`](<generated/sklearn.model_selection.LearningCurveDisplay.html#sklearn.model_selection.LearningCurveDisplay> "sklearn.model_selection.LearningCurveDisplay") will be easier to use. You can use the method [`from_estimator`](<generated/sklearn.model_selection.LearningCurveDisplay.html#sklearn.model_selection.LearningCurveDisplay.from_estimator> "sklearn.model_selection.LearningCurveDisplay.from_estimator") similarly to [`learning_curve`](<generated/sklearn.model_selection.learning_curve.html#sklearn.model_selection.learning_curve> "sklearn.model_selection.learning_curve") to generate and plot the learning curve:
...
![../_images/learning_curve-2.png](../_images/learning_curve-2.png)

Examples

  * See [Plotting Learning Curves and Checking Models’ Scalability](<../auto_examples/model_selection/plot_learning_curve.html#sphx-glr-auto-examples-model-selection-plot-learning-curve-py>) for an example of using learning curves to check the scalability of a predictive model.
